...
export default function Settings() {
    ...
    const tabs = [
        { id: 'profile' as TabId, label: 'Meu Perfil', icon: User },
        { id: 'password' as TabId, label: 'Senha', icon: KeyRound },
        ...(isAdmin
            ? [
        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-slate-500 text-sm mt-1">
                    Gerencie seu perfil e, quando permitido, as preferências globais do sistema.
                </p>
            </div>
